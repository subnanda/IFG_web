		...
		<table background="{{ url('image/bg-informasi.jpg') }}" style="width:100%; height:300px;">
			<tr>
				<td align="center" style="color:#FFFFFF; font-size:18px; padding-left:15px; padding-right:15px;">
					<div style="font-size:35px; font-weight:bold;">Informasi</div>
					<div>
					Informasi <font class="fa fa-angle-right" style="color:#fff; font-weight:bold; margin-left:7px; margin-right:7px;"></font> Informasi Berkala <font class="fa fa-angle-right" style="color:#fff; font-weight:bold; margin-left:7px; margin-right:7px;"></font> Informasi Tentang Indonesia Financial Group
					</div>
				</td>
			</tr>
		</table>
                    ...
                    <div class="full">
                        <div class="panel-group" id="accordion">
                          ...
                          foreach($content as $rowcontent){
                            ...
                            //echo $rowcontent->menu_link_slug.' '.$row->menu_link_slug;	
                          ?>
                          <div class="panel panel-default" <?php if($rowcontent->menu_link_slug <> $row->menu_link_slug){ ?>style="background-color:#E5E5E5;"<?php } ?>>
							<div class="panel-heading" <?php if($rowcontent->menu_link_slug == $row->menu_link_slug){ ?>style="background-image: linear-gradient(#ff0000, #F76675, #ff0000); padding:15px; color:#ffffff;"<?php } else { ?>style="padding:15px; color:#000000;"<?php } ?>>
							  <div class="panel-title">
								<a <?php if($numsub1){ ?>data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $row->id; ?>"<?php } else { ?> href="<?= url($row->menu_link_slug); ?>"<?php } ?> style="font-size:18px;"><font style="<?php if($numsub1){ if($rowcontent->menu_link_slug == $row->menu_link_slug){ echo 'color:#ffffff;'; }} else { if($rowcontent->menu_link_slug == $row->menu_link_slug){ echo 'color:#ffffff;'; } } ?>"><?php echo $row->menu_name; ?></font> <?php if($numsub1){ ?><font class="fa fa-chevron-down" style="float:right; margin-top:8px;"></font><?php } else { ?><?php } ?><!--<font style="float:right; position:absolute; margin-top:-18px;"><img src="http://localhost:8080/ifg/image/image/serong.png" style="width:20px;"></font>--></a>
							  </div>
							</div>
                            <?php
                            if($numsub1){
							...
							<div id="collapse<?php echo $row->id; ?>" class="panel-collapse collapse <?php if($rowcontent->menu_link_slug == $row->menu_link_slug){ echo 'show'; } ?>">
								<div style="background-color:#999999; color:#FFFFFF;">
                                  ...
                                  ?>
								  <div class="panel-body" style="padding:15px 15px 15px 25px; background-color:#666666;"><a href="<?= url($row2->menu_link_slug); ?>" style="color:#fff;"><?php echo $row2->menu_name; ?></a></div>
                ...
                <div class="col-md-9">
                    <div class="full" style="padding-top:20px; padding-left:10px; padding-right:10px; margin-bottom:20px;">
						...
						<div class="panel-group" id="accordion" style="margin-top:10px;">
                          ...
                          foreach ($query2 as $row2) {	
                          ?>
                            <a style="color:#000; font-size:15px;" href="<?= url($row2->item_link); ?>" target="_blank">
                                <div class="panel panel-default" style="background-color:#fff; box-shadow: 0 0 2px 2px #ccc; margin-bottom:10px;">
                                <div class="panel-title" style="padding:5px;">
                                    <?php echo $no; ?>. <?php echo $row2->item_title; ?> <font class="fa fa-file-pdf-o" style="float:right; color:#333333; margin-top:8px;"></font>
                                </div>
                                </div>
                            </a>
                          <?php $no++; } ?>
