    ...
    <div style="overflow-x: hidden;">
        ...
        <div class="section">
            <div class="" style="width:96%; margin-left:2%; margin-top:50px; margin-bottom:30px;">       
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center" style="margin-bottom: 0px;">
                        <?php 
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center" style="margin-top:-15px;">
                        ...
                        <div>
                            <div>
                                ...
                                <div id="myCompany" class="carousel slide w-100" data-ride="carousel">
                                    ...
                                    <!-- <div>    
                                        <ol class="carousel-indicators">
                                            ...
                                            for($i = 1;$j >= $i;$i++){
                                            ?>
                                            <li data-target="#myCompany" data-slide-to="<?php echo $i; ?>" <?php if($i == 1){ echo 'class="active"'; } ?>></li>
                                            <?php } ?>
                                        </ol>    
                                    </div> -->
                                    ...
                                    <div class="carousel-inner w-100" role="listbox">
                                        ...
                                        //     echo '<div class="carousel-item" style="width:100%;"><div class="col-lg-5 col-md-3 col-sm-3 col-3"></div></div>'; 
                                        // } else if($child_company_count == 2){ 
                                        //     echo '<div class="carousel-item" style="width:100%;"><div class="col-lg-4 col-md-3"></div></div>'; 
                                        // } else if($child_company_count == 3){ 
                                        //     echo '<div class="carousel-item" style="width:100%;"><div class="col-lg-3 col-md-1"></div></div>'; 
                                        // } ?>
                                    ...
                                    <a class="carousel-control-prev" id="left_slider_card2" href="#myCompany" role="button" data-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="sr-only">Previous</span>
                                    </a>
                                    <a class="carousel-control-next" id="right_slider_card2" href="#myCompany" role="button" data-slide="next">
                                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                        <span class="sr-only">Next</span>
                                    </a>
                                </div>
